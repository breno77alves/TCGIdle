  ...
  const LOCATIONS = [
    {
      ...
      dropCountRange: [1, 2],
      rarityLabel: "Inicial",
      duelModifiers: [{ trigger: "onAttack", flatDamage: 1, source: "Limiar de Aurin" }],
    ...
    },
    {
      ...
      duelModifiers: [{ trigger: "onDefend", flatMitigation: 2, source: "Praia de Mifnar" }],
      discoveryChance: 0.1,
      mapNode: { x: 46, y: 68 },
      adjacentLocationIds: ["limiar-de-aurin", "colonia-de-reinos"],
      actionPool: [
    ...
    },
    {
      ...
      dropCountRange: [3, 4],
      rarityLabel: "Arcano",
      duelModifiers: [{ trigger: "onCheck", stat: "wisdom", thresholdBonus: 4, source: "Cinturao do Passado" }],
